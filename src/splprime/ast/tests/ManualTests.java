...
public class ManualTests {
        ...
        private static Statement ifStatement() throws UnexpectedTokenException {
                return new IfStatement(
                                ...
                                new Block(
                                                new PrintStatement(
                                                                new LiteralExpression(
                                                                                new Token(TokenType.LIT_STRING,
                                                                                                "\"yes\"", "yes", 18)))
        ...
        private static Statement varStatement() throws UnexpectedTokenException {
                return new VariableDeclaration(
                                new Token(TokenType.IDENT, "average", null, 9),
                                new ArithmeticBinaryExpression(
                                                new ArithmeticBinaryExpression(
                                                                new LiteralExpression(new Token(TokenType.IDENT, "min",
                                                                                null, 10)),
                                                                new Token(TokenType.OP_PLUS, "+", null, 10),
                                                                new LiteralExpression(new Token(TokenType.IDENT, "max",
                                                                                null, 10))),
